...
echo "/"
call npx loadtest http://localhost:3000/ -t 20 -c 20 --keepalive
call npx loadtest -n 10000 http://localhost:3000/

echo "/main/login"
call npx loadtest http://localhost:3000/main/login -t 20 -c 20 --keepalive
call npx loadtest -n 10000 http://localhost:3000/main/login
